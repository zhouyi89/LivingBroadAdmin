...
import DeviceMana from './deviceMana'
const { Content } = Layout;
const networkMana = withRouter(class networkMana extends React.Component {
  constructor(props) {
    super(props);
    // 初始化 store
  }
  ...
  renderContent(key){
    ...
    switch(key) {
        case '1':
            content = (<DeviceMana   mleft={this.state.collapsed?64:200}/>);
            break;
        case '2':
            content = (<div />);
            break;
