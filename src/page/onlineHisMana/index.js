...
import HisMana from './HisMana'
const SubMenu = Menu.SubMenu;
const MenuItemGroup = Menu.ItemGroup;
const { Header, Content, Sider } = Layout;
const onlineHisMana = withRouter(class onlineHisMana extends React.Component {
  constructor(props) {
    super(props);
    // 初始化 store
  }
  ...
  renderContent(key){
    ...
    switch(key) {
        case '1':
            content = (<HisMana   mleft={this.state.collapsed?64:200}/>);
            break;
        case '2':
            content = (<div />);
            break;
